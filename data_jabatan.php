                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card-body">
                                ...
                                <form action="aksi_jabatan.php?act=insert" method="POST">
                                    ...
                                    <input type="text" class="form-control" name="namajabatan" require>
                                    </div>
                                    <div class="form-group">
                                    <label for="exampleFormControlInput1">Gaji Pokok</label>
                                    <input type="number" class="form-control" name="gajipokok" require>
                                    </div>
                                    <div class="form-group">
                                    <label for="exampleFormControlInput1">Tunjangan Jabatan</label>
                                    <input type="number" class="form-control" name="tunjanganjabatan" require>
                                    </div>
